...
RUNTIME_KEYS = frozenset(['MODEL_PROVIDER', 'MODEL_ID', 'BOX_API_KEY', 'BOX_TEMPLATE',
...
def runtime_environment(root, environ=None):
    ...
    allowed = ['MODEL_PROVIDER', 'MODEL_ID', 'BOX_API_KEY', 'BOX_TEMPLATE', *MODEL_KEYS.get(provider, [])]
