...
const operations=['mail_account','mail_activate','mail_status','mail_prepare','mail_send','mail_senders','mail_sender_allow','mail_sender_remove','mail_read_attachment','history_search','identity','companion_create','models','configure','companions','routines','routine_save','routine_delete','routine_history','routine_test','plugins','plugin_select','plugin_catalog','plugin_connect','plugin_custom','plugin_check','plugin_disconnect','triggers','trigger_save','trigger_delete','trigger_test','trigger_history','delegate','task_status','task_answer','task_cancel','deliveries','delivery_prepare','maintenance','maintenance_inspect','maintenance_configure','maintenance_prepare','maintenance_task','maintenance_history','templates','template_permission','prepare','template_save','template_history','template_rollback','software_prepare','software_status','spawn','adopt_template','specialist_configure','specialist_propose_improvement','specialist_keep_alive','specialist_install','ask_user','desktop_takeover','desktop_release',...localSkillOperations] as const;
